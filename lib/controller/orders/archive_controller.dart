...
import 'package:mealexpress/data/datasourse/remote/orders/archive_data.dart';
...
class OrdersArchiveController extends GetxController {
  ...
  submitRating( double rating ,String comment , String ordersid) async {

    data.clear();
    statusRequest = StatusRequest.loading;
    update();
    var response = await ordersArchiveData
        .rating(ordersid , rating.toString() , comment);
    print("=============================== Controller $response ");
    statusRequest = handlingData(response);
    if (StatusRequest.success == statusRequest) {
      // Start backend
